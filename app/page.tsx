...
const ACTIVITIES = [
  {
    ...
    desc: "Belt-based training that builds discipline, fitness and confidence.",
    tag: "Discipline & fitness",
  },
  {
    title: "Chess Academy",
    desc: "Mentored by experienced coaches to build focus, strategy and patience.",
    tag: "Sharp thinking",
  },
  {
    title: "Dance Academy",
    desc: "Classical and creative dance to support rhythm and stage presence.",
    tag: "Expression & rhythm",
  },
  {
    title: "Art Studio",
    desc: "Drawing and painting sessions that nurture creativity and observation.",
    tag: "Creative minds",
  },
  {
    title: "Music Studio",
    desc: "Vocal and instrumental basics through playful, age-appropriate songs.",
    tag: "Melody & joy",
  },
  {
    title: "Phonics Studio",
    desc: "Sound–letter mapping games to build strong reading foundations.",
    tag: "Strong readers",
  },
];
...
const INTRO_CARDS = [
  {
    ...
    desc: "A cosy, child-centric preschool blending joyful play, concepts and values for 2–5 year olds.",
    image: "/images/intro/preschool.jpg",
    cta: "Explore Preschool",
    href: "#about",
  },
  {
    title: "Indikids Activity Centre",
    desc: "Evening and weekend academies in sports, music and arts for 2–10 year olds.",
    image: "/images/intro/activity-centre.jpg",
      ...
      <main className="page">
        ...
        >
          <div className="section-header">
            <div className="section-header-badge">Our World</div>
            <h2>Indikids Preschool &amp; Activity Centre</h2>
            <p>
              One child-friendly campus for early learning, daycare and
              co-curricular academies – so parents have a single trusted space
        ...
        <section id="about" className="section" data-animate>
          <div className="section-header">
            <div className="section-header-badge">About Indikids</div>
            <h2>Preschool &amp; Daycare Programs</h2>
            <p>
              Indikids offers Playgroup, Nursery and KG along with flexible
              daycare – designed for holistic development of children aged 2–10
              years.
            </p>
          </div>
          ...
          <div className="about-facilities-grid">
            <div className="about-facility">
              ...
              <p>
                The curriculum follows an activity-based thematic approach with
                skill-based learning outcomes. Children build early literacy,
                numeracy, fine-motor skills and social confidence.
              </p>
              <p>
                We focus on cognitive, language, physical, social and emotional
                development so that each child moves to Grade 1 feeling ready.
              </p>
            ...
            <div className="about-facility">
              ...
              <p>
                Daycare provides a comfortable, child-centred environment for
                2–10 year olds, with flexible timings for working parents.
              </p>
              <p>
                Fun-filled learning activities, rest zones and supervised play
                keep children engaged, active and happy through the day.
              </p>
              <a href="#contact" className="btn btn-outline">
                Call Us
              </a>
        ...
        <section id="activities" className="section-light" data-animate>
          <div className="section-header">
            <div className="section-header-badge">Activity Centre</div>
            <h2>Indikids Academies &amp; Classes</h2>
            <p>
              Structured programs in sports, art and performing arts to help
              children discover and grow their talents.
            </p>
          </div>
        ...
        >
          ...
          <div className="ai-helper-card" data-animate>
            <div className="ai-helper-header">
              ...
              <h3 style={{ marginTop: "0.6rem" }}>IndiBot – Admissions Helper</h3>
